...
//=========================================================================================================
    ...
    var a = jQuery.post('admin-ajax.php',{'action':action,nonce:window.sfpSettings.addNonce,data:JSON.stringify(model)});
    a.done(function () { console.log('works');});
    a.fail(function () { console.log('not');});
    ...
    /*
     model = [
        name:'Model_name1',
        title:'title_label1',
        content:'content_label1',
        fields:[
        {name:'field11',type:'date'},
    ...
    */
    ...
    for(var field in fields)
    {
        testFields +=fields[field]['name']+'  '+fields[field]['type']+'\n';
    }
